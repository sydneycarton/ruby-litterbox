...
describe User do
	...
	describe "when the password confirmation is null" do
	...
	describe "when email format is invalid" do
		it "should be invalid" do
			baddresses=%w[users@foo,com user_at_foo.org example.user@foo. foo@bar_baz.com foo@bar+baz.com]
			baddresses.each do |baddress|
				@user.email = baddress
